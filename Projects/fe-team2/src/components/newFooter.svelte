...
<div class="w-screen h-[138px] bg-white dark:bg-black text-left">
  ...
  <div class="flex items-center ml-[19px]">
    ...
    <p
      class="text-neutral-900 dark:text-[#e5e5e5] font-['PRETENDARD-REGULAR'] text-[13px]"
    >
      010-4939-1971
    </p>
  </div>
  ...
  <p
    class="text-[13px] text-neutral-900 dark:text-[#E5E5E5] font-['PRETENDARD-REGULAR'] mt-[6px] ml-[18px]"
  >
