<script>
  ...
  <div class="flex flex-col justify-start items-center w-screen">
    <div
      class="flex-grow-0 flex-shrink-0 w-[324px] h-[188px] rounded-[20px] bg-white/90 absolute"
      style="box-shadow: 0px 0px 15px 0.20000000298023224px rgba(0,0,0,0.1);"
    >
    <p class="flex-grow-0 flex-shrink-0 w-[339px] text-xs text-center font-['Pretendard'] text-[#191919] mt-10">
      <span class="flex-grow-0 flex-shrink-0 w-[339px] text-xs text-center text-[#191919]">
        1987년부터 2024년까지 이어져 온 전통있는 스터디이며</span
      ><br /><span class="flex-grow-0 flex-shrink-0 w-[339px] text-xs text-center text-[#191919]"
