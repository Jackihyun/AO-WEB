    ...
    <div class="z-10 p-6 rounded-xl">
      ...
      >
        ...
        >
          ...
          <div
            class="flex justify-start items-start flex-grow-0 flex-shrink-0 w-[252px] gap-2.5"
          >
            <button
              type="button"
            ...
            >
              <p
                class="flex-grow-0 flex-shrink-0 text-base font-bold text-center text-white cursor-pointer"
              >
                확인
              </p>
            </button>
